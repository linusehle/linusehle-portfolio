<template>
    ...
    <div id="home" class="bg-[#120e16] h-screen flex items-center">
        <div class="flex flex-col py-12 px-4 md:px-[125px] lg:px-[300px] test">
            ...
            <div class="flex space-x-6 text-white mt-6">
                <div>
                ...
                <div>
                    <a href="" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="text-white h-6 hover:text-[#9f55ff]">
        ...
        <div class="flex flex-col pb-10">
            <div class="w-full flex justify-center">
                <form class="px-4 sm:w-[30rem] md:w-[45rem] space-y-[75px] w-full">
                    <div class="relative">
                        <input type="text" id="name_input" class="block leading-[40px] w-full px-2.5 pb-2.5 pt-4 sm:w-full h-12 sm:h-[75px] bg-transparent rounded-[0.6rem] border-2 border-[#7000ff] text-white focus:outline-none peer" placeholder="" />
                    ...
                    <div class="relative">
                        <input type="email" id="name_input" class="block w-full px-2.5 pb-2.5 pt-4 sm:w-full h-12 sm:h-[75px]  bg-transparent rounded-[0.6rem] border-2 border-[#7000ff] text-white focus:outline-none peer" placeholder="" />
                        <label for="name_input" class="absolute text-white text-2xl font-mono duration-300 transform -translate-y-4 top-2 z-10 origin-[0] bg-transparent px-2 peer-focus:px-2 peer-focus:text-white peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-[-18px] peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Email</label>
                    </div>
                    <div class="relative">
                        <textarea id="message" class="block h-auto w-full px-2.5 pb-2.5 pt-4 sm:w-full min-h-[10rem] max-h-[20rem] sm:h-14  bg-transparent rounded-[0.6rem] border-2 border-[#7000ff] text-white focus:outline-none peer" placeholder=""></textarea>
                        <label for="message" class="absolute text-white text-2xl font-mono duration-300 transform z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-white  peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-6 peer-focus:top-[-18px] peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Message</label>
                    </div>
                </form>
            </div>
...
@keyframes words {
    0%,20%{
        content: "A passionate developer";
    }
    21%,40%{
        content: "I create pleasing and modern software";
    }
    41%,60%{
        content: "change later";
    }
    61%,80%{
        content: "change later";
    }
...
export default {
    methods: {
        projects_wheel (event) {
            ...
            document.getElementById("projects-wrapper").scrollBy({
