          ...
          <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
            <div className="mt-24 text-4xl font-bold tracking-tight sm:mt-10 sm:text-6xl">
              ...
              <div className="flex space-x-4">
                <span
                className="emphasize border-gradient border-gradient-green font-bold text-6xl only-top"
                >
                  Linus
                </span>
                <span
            ...
            <div className="my-12">
              <p>
                <span
                ref={typedEl}
                className="sq text-3xl text-gray-light-3 font-mono leading-relaxed"
                />
              </p>
            </div>
            <div className="flex gap-6">
              ...
              >
                ...
                >
                  <path
                  d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9
              ...
              >
                ...
                >
                  ...
                  2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6
                  6 0 0 1 6-6z"
                  />
                  <rect
                  x={2}
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                  d="M16 11.37A4 4 0 1 1 12.63
                  8 4 4 0 0 1 16 11.37z"
                  />
                  <line 
                  x1={17.5}
                  y1={6.5}
              ...
              >
                ...
                >
                  ...
                  4.48 4.48 0 0 0-7.86 3v1A10.66 10.66
                  0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 
                  1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 
