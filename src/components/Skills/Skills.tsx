function Skills () {
    return (
        <div id="skills" className="bg-[#120e16] h-screen">
  <div className="flex flex-col py-12 px-4 md:px-[125px] lg:px-[300px] fade-animation">
    <div className="">
      <span className="font-medium text-base uppercase tracking-widest text-white">
        skills
      </span>
    </div>
    <div>
    ...
    <div className="w-full sm:max-w-lg pt-4">
      <span className="font-semibold text-[1.65rem] text-white md:text-3xl">
        I like to build things with code and to always learn new things.
      </span>
    </div>
    <div className="pt-16 fade-animation">
      <div>
        <span className="font-medium text-base uppercase tracking-widest text-gray-200">
          languages and tools
        </span>
      </div>
      <div className="flex flex-wrap mt-6 space-x-4 items-center justify-start">
        <div>
          <svg
            className="h-14"
    ...
    <div className="pt-8 fade-animation">
      <div>
        <span className="font-medium text-base uppercase tracking-widest text-white">
          other
        </span>
      </div>
      <div className="flex mt-6 space-x-4 pb-10">
        <div>
          <svg
            className="h-14"
            viewBox="0 0 32 32"
